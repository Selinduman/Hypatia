...
**Recycling Movement in the World**
...
The primary objective of the project is to raise awareness on recyling in the World.The number of waste in the world is increasing day by day because we are in an order based on the increase in the world population, industrialization and consumption. We will present  recyling rates for each waste type and human’s waste rates.In our Project these questions will be answered.   
...
- What is the the percentages of municipal waste up to recyling rates by country 2019  that is recycled, incinerated, incinerated to produce energy and landfilled.   
...
The primary purpose of the project is to raise awareness about recyling  all the world, the results and facts will be understandable from all segments of the society.Our final product will be to analysing to recycling movement's evolution from different perspectives.
